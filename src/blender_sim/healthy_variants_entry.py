"""
  blender --background --python src/blender_sim/healthy_variants_entry.py -- job.json
"""
...
if "--" not in sys.argv:
    print(
        "Usage: blender --background --python src/blender_sim/healthy_variants_entry.py -- job.json",
        file=sys.stderr,
    )
    sys.exit(1)
