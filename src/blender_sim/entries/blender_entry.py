...
Invoke from project root:
  ...
  blender --background --python src/blender_sim/entries/blender_entry.py -- path/to/blender_config.json
...
# Custom args after "--"
if "--" not in sys.argv:
    print("Usage: blender --background --python src/blender_sim/entries/blender_entry.py -- blender_config.json")
    sys.exit(1)
